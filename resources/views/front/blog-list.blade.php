                            ...
                            <div class="blog-custom-build mt-1">
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="" title="">
                                            <img src="{{$article['img_path']}}" alt="" class="img-fluid rounded">
                                    ...
                                    <div class="blog-meta big-meta text-center">
                                        ...
                                        <h4><a href="{{route('article.show', ['articleId'=>$article['id']])}}" title="" class="fs-2 fw-bold text-decoration-none">{{$article['title']}}</a></h4>
                                        <p class="fs-5 fw-bold">{{$article['short_description']}}</p>
                                        <small><a href="marketing-single.html" title=""class="text-decoration-none">{{$article['created_at']}}</a></small>
                                        <small><a href="#" title="" class="text-decoration-none">by {{$article['author']}}</a></small>
